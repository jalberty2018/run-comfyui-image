...
# run-comfyui-image
FROM ls250824/comfyui-runtime:24062026
...
RUN --mount=type=cache,target=/root/.cache/git \
	...
	git clone --depth=1 --filter=blob:none https://github.com/nova452/ComfyUI-ConditioningKrea2Rebalance.git
...
# Labels
LABEL org.opencontainers.image.title="ComfyUI 0.26.0 for image inference" \
