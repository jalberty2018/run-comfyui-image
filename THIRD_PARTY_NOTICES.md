...
|---|---|
| Base image | [ls250824/comfyui-runtime](https://hub.docker.com/r/ls250824/comfyui-runtime), using the tag in the Dockerfile. Its included software retains its respective licenses. |
...
[manual model downloads](docs/ComfyUI_image_provisioning.md) identify sources.
Each image model, text encoder, VAE, LoRA, segmentation model, upscaler and
